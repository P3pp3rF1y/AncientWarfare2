 ...
 *
 */
public class InventorySidedWithContainer implements IInventorySaveable, ISidedInventory
{
...
private ItemSlotFilter[] inventorySlotFilters;
...
public InventorySidedWithContainer(int size, ISidedTile te)
  {
  this.te = te;
  inventorySlots = new ItemStack[size];
  inventorySlotFilters = new ItemSlotFilter[size];
  RelativeSide side;
...
public void addSlotFilter(int slot, ItemSlotFilter filter)
  {
...
public ItemSlotFilter getFilterForSlot(int slot)
  {
  return inventorySlotFilters[slot];
  }
