...
public class RenderRegistry {
	...
	public void loadRenders() {
		...
		this.addMissileRender(ItemAmmo.ammoStoneShot10.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoStoneShot15.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoStoneShot30.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoStoneShot45.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoFireShot10.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoFireShot15.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoFireShot30.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoFireShot45.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoClusterShot10.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoClusterShot15.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoClusterShot30.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoClusterShot45.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoPebbleShot10.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoPebbleShot15.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoPebbleShot30.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoPebbleShot45.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoNapalm10.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoNapalm15.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoNapalm30.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoNapalm45.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoExplosive10.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoExplosive15.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoExplosive30.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoExplosive45.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoHE10.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoHE15.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoHE30.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoHE45.getAmmoType(), shotRender);

		this.addMissileRender(ItemAmmo.ammoIronShot5.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoIronShot10.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoIronShot15.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoIronShot25.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoGrapeShot5.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoGrapeShot10.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoGrapeShot15.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoGrapeShot25.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoCanisterShot5.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoCanisterShot10.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoCanisterShot15.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoCanisterShot25.getAmmoType(), shotRender);

		this.addMissileRender(ItemAmmo.ammoArrow.getAmmoType(), arrowRender);
		this.addMissileRender(ItemAmmo.ammoArrowIron.getAmmoType(), arrowRender);
		this.addMissileRender(ItemAmmo.ammoArrowFlame.getAmmoType(), arrowRender);
		this.addMissileRender(ItemAmmo.ammoArrowIronFlame.getAmmoType(), arrowRender);
		this.addMissileRender(ItemAmmo.ammoRocket.getAmmoType(), arrowRender);
		this.addMissileRender(ItemAmmo.ammoHwachaRocketFlame.getAmmoType(), arrowRender);
		this.addMissileRender(ItemAmmo.ammoHwachaRocketExplosive.getAmmoType(), arrowRender);
		this.addMissileRender(ItemAmmo.ammoHwachaRocketAirburst.getAmmoType(), arrowRender);
		this.addMissileRender(ItemAmmo.ammoBallistaBolt.getAmmoType(), arrowRender);
		this.addMissileRender(ItemAmmo.ammoBallistaBoltExplosive.getAmmoType(), arrowRender);
		this.addMissileRender(ItemAmmo.ammoBallistaBoltFlame.getAmmoType(), arrowRender);
		this.addMissileRender(ItemAmmo.ammoBallistaBoltIron.getAmmoType(), arrowRender);

		this.addMissileRender(ItemAmmo.ammoBallShot.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoBallIronShot.getAmmoType(), shotRender);

		this.addMissileRender(ItemAmmo.ammoSoldierArrowWood.getAmmoType(), arrowRender);
		this.addMissileRender(ItemAmmo.ammoSoldierArrowIron.getAmmoType(), arrowRender);
		this.addMissileRender(ItemAmmo.ammoSoldierArrowWoodFlame.getAmmoType(), arrowRender);
		this.addMissileRender(ItemAmmo.ammoSoldierArrowIronFlame.getAmmoType(), arrowRender);

		this.addMissileRender(ItemAmmo.ammoTorpedo10.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoTorpedo15.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoTorpedo30.getAmmoType(), shotRender);
		this.addMissileRender(ItemAmmo.ammoTorpedo45.getAmmoType(), shotRender);
