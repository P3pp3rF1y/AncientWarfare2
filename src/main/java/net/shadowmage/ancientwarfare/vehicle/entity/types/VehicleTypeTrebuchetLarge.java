...
public class VehicleTypeTrebuchetLarge extends VehicleType {
	...
	public VehicleTypeTrebuchetLarge(int typeNum) {
		...
		this.ammoBySoldierRank.put(0, ItemAmmo.ammoStoneShot30);
		this.ammoBySoldierRank.put(1, ItemAmmo.ammoStoneShot30);
		this.ammoBySoldierRank.put(2, ItemAmmo.ammoStoneShot30);
