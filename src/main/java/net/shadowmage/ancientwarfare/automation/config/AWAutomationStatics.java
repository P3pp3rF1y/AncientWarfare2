...
public class AWAutomationStatics extends ModConfiguration {
	...
	public void initializeValues() {
		...
		double temp = config.get(generalOptions, "rf_energy_conversion_factor", torqueToRf,
		...
		energyMinNetworkUpdateFrequency = config.get(generalOptions, "energy_network_update_frequency", energyMinNetworkUpdateFrequency,
		...
		enable_energy_network_updates = config.get(serverOptions, "enable_server_energy_network", enable_energy_network_updates,
		...
		mailboxTimePerBlock = config.get(serverOptions, "mailbox_travel_time_per_block", mailboxTimePerBlock,
		...
		mailboxTimeForDimension = config.get(serverOptions, "mailbox_travel_time_per_dimension", mailboxTimeForDimension,
		...
		low_efficiency_factor = config.get(serverOptions, "low_quality_tile_energy_drain", low_efficiency_factor,
		...
		med_efficiency_factor = config.get(serverOptions, "med_quality_tile_energy_drain", med_efficiency_factor,
		...
		high_efficiency_factor = config.get(serverOptions, "high_quality_tile_energy_drain", high_efficiency_factor,
		...
		low_transfer_max = config.get(serverOptions, "low_quality_tile_energy_transfer", low_transfer_max,
		...
		med_transfer_max = config.get(serverOptions, "med_quality_tile_energy_transfer", med_transfer_max,
		...
		high_transfer_max = config.get(serverOptions, "high_quality_tile_energy_transfer", high_transfer_max,
		...
		low_conduit_energy_max = config.get(serverOptions, "low_quality_conduit_energy_max", low_conduit_energy_max,
		...
		med_conduit_energy_max = config.get(serverOptions, "med_quality_conduit_energy_max", med_conduit_energy_max,
				"How much energy may be stored in medium-quality energy transport tiles.\n" + "Default = " + med_conduit_energy_max + "\n" + "Directly sets the amount of torque/MJ that a transport conduit may store internally.")
				.getDouble();

		high_conduit_energy_max = config.get(serverOptions, "high_quality_conduit_energy_max", high_conduit_energy_max,
				"How much energy may be stored in high-quality energy transport tiles.\n" + "Default = " + high_conduit_energy_max + "\n" + "Directly sets the amount of torque/MJ that a transport conduit may store internally.")
				.getDouble();

		low_storage_energy_max = config.get(serverOptions, "low_quality_storage_energy_max", low_storage_energy_max,
		...
		med_storage_energy_max = config.get(serverOptions, "med_quality_storage_energy_max", med_storage_energy_max,
				"How much energy may be stored in medium-quality energy storage tiles.\n" + "Default = " + med_storage_energy_max + "\n" + "Directly sets the amount of torque/MJ that a storage tile may store internally.")
				.getDouble();

		high_storage_energy_max = config.get(serverOptions, "high_quality_storage_energy_max", high_storage_energy_max,
		...
		hand_cranked_generator_output = config.get(serverOptions, "hand_cranked_generator_output_factor", hand_cranked_generator_output,
		...
		crop_farm_blocks = config.get(serverOptions, "crop_farm_blocks", crop_farm_blocks,
		...
		animal_farm_pickups = config.get(serverOptions, "animal_farm_pickups", animal_farm_pickups,
