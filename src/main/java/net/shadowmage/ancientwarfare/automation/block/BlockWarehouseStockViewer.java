...
public class BlockWarehouseStockViewer extends BlockBaseAutomation implements IRotatableBlock {
    ...
    static {
        ...
        float hmin = 0.375f;
        float hmax = 0.875f;
        AABBS = ImmutableMap.of(
                EnumFacing.WEST, new AxisAlignedBB(wmax, hmin, 0, 1.f, hmax, 1),
                EnumFacing.EAST, new AxisAlignedBB(0, hmin, 0, wmin, hmax, 1),
                EnumFacing.SOUTH, new AxisAlignedBB(0, hmin, 0, 1, hmax, wmin),
                EnumFacing.NORTH, new AxisAlignedBB(0, hmin, wmax, 1, hmax, 1)
        );
    }
