...
public abstract class BaseTorqueRendererGeneric<T extends TileTorqueBase> extends AnimatedBlockRenderer {
    protected BaseTorqueRendererGeneric(String modelPath) {
        super(modelPath);
    }
