...
public enum WorksiteUpgrade {
	 ...
	 */
	SIZE_MEDIUM(new int[] {}, new int[] {}), SIZE_LARGE(new int[] {0}, new int[] {0}), QUARRY_MEDIUM(new int[] {}, new int[] {}), QUARRY_LARGE(new int[] {2}, new int[] {
			2}), ENCHANTED_TOOLS_1(new int[] {}, new int[] {}), ENCHANTED_TOOLS_2(new int[] {4}, new int[] {4}), TOOL_QUALITY_1(new int[] {}, new int[] {}), TOOL_QUALITY_2(new int[] {
			6}, new int[] {6}), TOOL_QUALITY_3(new int[] {7, 8}, new int[] {7,
			8}), BASIC_CHUNK_LOADER(new int[] {}, new int[] {}), QUARRY_CHUNK_LOADER(new int[] {}, new int[] {}),;
