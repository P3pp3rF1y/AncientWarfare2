...
public static final String NPC_FACTION_BANDIT_CAVALRY = "aw_npc_bandit_cavalry";
public static final String NPC_FACTION_BANDIT_MOUNTED_ARCHER = "aw_npc_bandit_mounted_archer";
...
public static final String NPC_FACTION_PIRATE_CAVALRY = "aw_npc_pirate_cavalry";
public static final String NPC_FACTION_PIRATE_MOUNTED_ARCHER = "aw_npc_pirate_mounted_archer";
...
public static final String NPC_FACTION_NATIVE_CAVALRY = "aw_npc_native_cavalry";
public static final String NPC_FACTION_NATIVE_MOUNTED_ARCHER = "aw_npc_native_mounted_archer";
...
public static final String NPC_FACTION_DESERT_CAVALRY = "aw_npc_desert_cavalry";
public static final String NPC_FACTION_DESERT_MOUNTED_ARCHER = "aw_npc_desert_mounted_archer";
...
public static final String NPC_FACTION_VIKING_CAVALRY = "aw_npc_viking_cavalry";
public static final String NPC_FACTION_VIKING_MOUNTED_ARCHER = "aw_npc_viking_mounted_archer";
