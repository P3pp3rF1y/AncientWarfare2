...
public class CoreProperties {
	...
	public static final IUnlistedProperty<EnumFacing> UNLISTED_HORIZONTAL_FACING = net.minecraftforge.common.property.Properties
			.toUnlisted(BlockHorizontal.FACING);
