...
public class EngineeringStationRenderer implements ISimpleBlockBakery {
	...
	static {
		models = OBJParser.parseModels(new ResourceLocation(AncientWarfareCore.modID, "models/block/engineering_station.obj"), 7, new RedundantTransformation());
	}
	...
	public List<BakedQuad> bakeQuads(@Nullable EnumFacing face, IExtendedBlockState state) {
		...
		for (CCModel model : models.values()) {
