...
public class AWCoreStatics extends ModConfiguration {
	...
	public void initializeValues() {
		...
		energyPerWorkUnit = config.get(serverOptions, "energy_per_work_unit", energyPerWorkUnit,
         ...
         * research settings
         */
		energyPerResearchUnit = config.get(researchSettings, "energy_used per_research_tick", energyPerResearchUnit,
	...
	public void initializeCategories() {
		...
		config.addCustomCategoryComment(researchSettings,
				"Research Settings Section\n" + "Affect both client and server.  These configs must match for client and server, or\n" + "strange and probably BAD things WILL happen.");

		config.addCustomCategoryComment(researchDetailSettings,
				"Research Detail Settings Section\n" + "Configure research times per research goal.\n" + "Affect both client and server.  These configs must match for client and server, or\n" + "strange and probably BAD things WILL happen.");

		config.addCustomCategoryComment(recipeDetailSettings,
		...
		config.addCustomCategoryComment(recipeResearchDetails,
