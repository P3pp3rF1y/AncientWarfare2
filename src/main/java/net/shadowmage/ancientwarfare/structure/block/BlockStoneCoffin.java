...
public class BlockStoneCoffin extends BlockBaseStructure {
	...
	public BlockStoneCoffin() {
		super(Material.WOOD, "stone_coffin");
	}
	...
	////		boolean upright = !ItemBlockStoneCoffin.canPlaceHorizontal(worldIn, pos, facing, placer);
	...
	public void registerClient() {
		ModelLoaderHelper.registerItem(this, StoneCoffinRenderer.MODEL_LOCATION);
