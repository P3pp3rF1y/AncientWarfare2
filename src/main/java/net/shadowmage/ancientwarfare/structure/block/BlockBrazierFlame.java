...
public class BlockBrazierFlame extends BlockBaseStructure {
	public static final String LIT_TAG = "lit";
	private static final PropertyBool LIT = PropertyBool.create(LIT_TAG);

	private static final AxisAlignedBB AABB = new AxisAlignedBB(0D, 0D, 0D, 1D, 0.58D, 1D);

	public BlockBrazierFlame() {
		super(Material.ROCK, "brazier_flame");
		setHardness(2);
	...
	public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
		ItemStack BlockBrazierFlame = new ItemStack(this);
		BlockBrazierFlame.setTagCompound(new NBTBuilder().setBoolean(LIT_TAG, false).build());
		drops.add(BlockBrazierFlame);
	}
