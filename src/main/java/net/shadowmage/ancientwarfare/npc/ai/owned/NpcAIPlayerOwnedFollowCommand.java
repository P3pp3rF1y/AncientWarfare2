...
@Override
public boolean shouldExecute(){return continueExecuting();}
...
private void handleMoveCommand(Command cmd)
  {
  if(moveTargetPos==null || moveTargetPos.x!=cmd.x || moveTargetPos.y!=cmd.y || moveTargetPos.z!=cmd.z){moveTargetPos = new BlockPosition(cmd.x, cmd.y, cmd.z);}
