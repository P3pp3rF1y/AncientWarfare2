...
public class RenderCommandOverlay {
    ...
    public void onClientTick(ClientTickEvent evt) {
        ...
        for (Entity e : targetEntities) {
            if (e instanceof NpcBase) {
                ...
                name = StatCollector.translateToLocal(e.getCommandSenderName());
            }
    ...
    public void onRenderTick(RenderTickEvent evt) {
        ...
        if (player == null || player.getCurrentEquippedItem() == null || !(player.getCurrentEquippedItem().getItem() instanceof ItemCommandBaton)) {
            return;
        }
